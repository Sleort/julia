...
; TYPED-NEXT: %v = call noalias {} addrspace(10)* @julia.gc_alloc_bytes(i8* [[ptls_i8]], [[SIZE_T:i.[0-9]+]] 8, {} addrspace(10)* @tag)
...
; OPAQUE-NEXT: %v = call noalias ptr addrspace(10) @julia.gc_alloc_bytes(ptr [[ptls_load]], [[SIZE_T:i.[0-9]+]] 8, ptr addrspace(10) @tag)
